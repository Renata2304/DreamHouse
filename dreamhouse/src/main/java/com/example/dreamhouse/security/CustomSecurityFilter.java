...
public class CustomSecurityFilter implements Filter {
    ...
    public CustomSecurityFilter() throws MalformedURLException {
        jwkProvider = new JwkProviderBuilder(new URL("http://localhost:9990/realms/master/protocol/openid-connect/certs")).build();
    }
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        try {
            ...
            JWTVerifier verifier = JWT.require(algorithm)
                    .withIssuer("http://localhost:9990/realms/master")
                    .build();
